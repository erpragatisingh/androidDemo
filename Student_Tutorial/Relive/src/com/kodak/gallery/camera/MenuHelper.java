...
import com.kodak.gallery.dependencies.MediaMetadataRetriever;
...
public class MenuHelper {
    ...
    public static final int INCLUDE_EDIT_MENU	  		= (1 << 8);//3
    public static final int INCLUDE_PRINT_MENU    		= (1 << 9);//4
    public static final int INCLUDE_PROTECT_MENU  		= (1 << 10);//7
    public static final int INCLUDE_UNPROTECT_MENU		= (1 << 11);//8
...
//    public static final int POSITION_IMAGE_TOSS = 8;//delete button 7
...
//    public static final int POSITION_IMAGE_PRINT = 17;
//    public static final int POSITION_IMAGE_EDIT = 18;
//    public static final int POSITION_IMAGE_PROTECT = 19;
//    public static final int POSITION_IMAGE_UNPROTECT = 20;
    ...
    public static final int POSITION_IMAGE_EDIT = 8;
    public static final int POSITION_IMAGE_PRINT = 9;
    public static final int POSITION_SLIDESHOW = 10;
    public static final int POSITION_IMAGE_SET = 11;
    public static final int POSITION_IMAGE_ROTATE = 12;
    public static final int POSITION_IMAGE_PROTECT = 13;
    public static final int POSITION_IMAGE_UNPROTECT = 14;
    public static final int POSITION_DETAILS = 15;
    public static final int POSITION_SHOWMAP = 16;
    public static final int POSITION_IMAGE_CROP = 17;     
    public static final int POSITION_MULTISELECT = 18;
    public static final int POSITION_CAMERA_SETTING = 19;
    public static final int POSITION_GALLERY_SETTING = 20;
    ...
    public static MenuItemsResult addImageMenuItems(
            Menu menu,
            int inclusions,
            final Activity activity,
            final Handler handler,
        ...
        if ((inclusions & INCLUDE_EDIT_MENU) != 0) {
            SubMenu editSubmenu = menu.addSubMenu(Menu.NONE, Menu.NONE,
                    POSITION_IMAGE_EDIT, R.string.edit_menu)
                    .setIcon(android.R.drawable.ic_menu_rotate);//TODO SMITA
            requiresWriteAccessItems.add(editSubmenu.getItem());
            // Don't show the rotate submenu if the item at hand is read only
            // since the items within the submenu won't be shown anyway. This
            // is really a framework bug in that it shouldn't show the submenu
            // if the submenu has no visible items.

		        MenuItem crop = editSubmenu.add(R.string.camera_crop)
		                .setOnMenuItemClickListener(
		                new MenuItem.OnMenuItemClickListener() {
		                    public boolean onMenuItemClick(MenuItem item) {
		                    	//HCL Release2
		        ...
		        crop.setIcon(android.R.drawable.ic_menu_crop);
		        requiresWriteAccessItems.add(crop);
		        requiresImageItems.add(crop);
		        
		        MenuItem trim = editSubmenu.add(R.string.trim)
                .setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        return true;//TODO HCL
                    }
                });
                requiresWriteAccessItems.add(trim);
                requiresVideoItems.add(trim);
 
            	MenuItem tagPeople = editSubmenu.add(R.string.tag_people_menu)
                .setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        return true;//TODO HCL
		        ...
		        requiresWriteAccessItems.add(tagPeople); 

            
		       MenuItem addLocation = editSubmenu.add(R.string.add_location_menu)
                .setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        return true;//TODO HCL
                ...
                requiresWriteAccessItems.add(addLocation);
                requiresImageItems.add(addLocation);
            
                MenuItem add_action = editSubmenu.add(R.string.add_action)
                .setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        return true;//TODO HCL
                ...
                requiresWriteAccessItems.add(add_action);
                requiresVideoItems.add(add_action);

            	MenuItem keywordTag = editSubmenu.add(R.string.tag_keyword_menu)
                .setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        return true;//TODO HCL
                ...
                requiresWriteAccessItems.add(keywordTag);
                
                MenuItem addDateTimeStamp = editSubmenu.add(R.string.add_date_timestamp_menu)
                .setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        return true;//TODO HCL
                ...
                requiresWriteAccessItems.add(addDateTimeStamp);
                requiresImageItems.add(addDateTimeStamp);            	
                
        }
        if ((inclusions & INCLUDE_PRINT_MENU) != 0) {
            MenuItem printMenu = menu.add(Menu.NONE, Menu.NONE,
            		POSITION_IMAGE_PRINT, R.string.print_menu);
            printMenu.setIcon(android.R.drawable.ic_menu_set_as);
            printMenu.setOnMenuItemClickListener(
                    new MenuItem.OnMenuItemClickListener() {
                        public boolean onMenuItemClick(MenuItem item) {
                            return true;//TODO HCL
                        }
                    });
            requiresWriteAccessItems.add(printMenu);
            requiresImageItems.add(printMenu);
        }
        
        if ((inclusions & INCLUDE_PROTECT_MENU) != 0) {
            MenuItem protectMenu = menu.add(Menu.NONE, Menu.NONE,
            		POSITION_IMAGE_PROTECT, R.string.protect_menu)
            .setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                public boolean onMenuItemClick(MenuItem item) {
                    return true;//TODO HCL
                }
            });
            protectMenu.setIcon(R.drawable.ic_menu_view_details);
            requiresWriteAccessItems.add(protectMenu);
        }
        if ((inclusions & INCLUDE_UNPROTECT_MENU) != 0) {
            MenuItem unProtectMenu = menu.add(Menu.NONE, Menu.NONE,
            		POSITION_IMAGE_UNPROTECT, R.string.unprotect_menu)
            .setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                public boolean onMenuItemClick(MenuItem item) {
                    return true;//TODO HCL
                }
            });
            unProtectMenu.setIcon(R.drawable.ic_menu_view_details);
            requiresWriteAccessItems.add(unProtectMenu);
        }
...
//                                    onDelete);
        ...
        if ((inclusions & INCLUDE_DETAILS_MENU) != 0) {
            MenuItem detailsMenu = menu.add(Menu.NONE, Menu.NONE,
                POSITION_DETAILS, R.string.properties_menu)
            .setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                public boolean onMenuItemClick(MenuItem item) {
    ...
    private static void startCameraActivity(Activity activity, String action) {
      ...
      //Arti  CameraHolder.instance().keep();
    ...
    public static void addCapturePictureMenuItems(Menu menu, final Activity activity) {
    ...
    public static void addCaptureVideoMenuItems(Menu menu, final Activity activity) {
    ...
    //ADDED BY HCL
    public static void captureMenuItem(Menu menu, final Activity activity ) {
