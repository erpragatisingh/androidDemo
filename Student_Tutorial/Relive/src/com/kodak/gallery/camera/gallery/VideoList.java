...
package com.kodak.gallery.camera.gallery;
...
public class VideoList extends BaseImageList {
    ...
    public static String mClause;
    public static boolean IsClauseChanged = false;
    @Override
    ...
    public static void setWhereClause(String newClause)
    {
    	mClause = newClause; 
    	IsClauseChanged = true;
    }
    ...
    protected Cursor createCursor() {
        ...
        if (!IsClauseChanged)
    	{
	        c = Images.Media.query(
	                mContentResolver, mBaseUri, VIDEO_PROJECTION,
	                whereClause(), whereClauseArgs(), sortOrder());
    	}else{
	        c =Images.Media.query(mContentResolver, mBaseUri, VIDEO_PROJECTION,
	                getWhereClause(), null, sortOrder());
    	}
        return c;
    }
}
