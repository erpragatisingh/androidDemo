...
public class ViewImage extends Activity implements View.OnClickListener {
    ...
    public boolean dispatchTouchEvent(MotionEvent m) {
        ...
        }Log.d(TAG, this.toString()+"  dispatchTouchEvent()");//Arti
    ...
    protected void onDestroy() {
        ...
        super.onDestroy();
        Log.d(TAG, this.toString()+"  onDestroy()");//Arti
    }
    ...
    private class MyGestureListener extends
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2,
            ...
            Log.d(TAG, this.toString()+"  onScroll()");//Arti
            return true;
        }
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            setMode(MODE_NORMAL);
            Log.d(TAG, this.toString()+"  onSingleTapUp()");//Arti
            return true;
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            showOnScreenControls();
            scheduleDismissOnScreenControls();
            Log.d(TAG, this.toString()+"  onSingleTapConfirmed()");//Arti
            return true;
        }
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            Log.d(TAG, this.toString()+"  onDoubleTap()");//Arti
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        Log.d(TAG, this.toString()+"  onCreateOptionsMenu()");//Arti
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        Log.d(TAG, this.toString()+"  onPrepareOptionsMenu()");//Arti
        setMode(MODE_NORMAL);
        IImage image = mAllImages.getImageAt(mCurrentPosition);
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
        ...
        Log.d(TAG, this.toString()+"  onMenuItemSelected()");//Arti
        return b;
    }
    ...
    public void onCreate(Bundle instanceState) {
        ...
        Log.d(TAG, this.toString()+"  onCreate()");//Arti
        Intent intent = getIntent();
        mFullScreenInNormalMode = intent.getBooleanExtra(
               ReviewImage.EXTRA_FULL_SCREEN, true);//Arti
        mShowActionIcons = intent.getBooleanExtra(
                EXTRA_SHOW_ACTION_ICONS, true);//Arti
    ...
    public void onStart() {
        ...
        Log.d(TAG, this.toString()+"  onStart()");//Arti
        if (!init(mSavedUri)) {
    ...
    public void onStop() {
        ...
        Log.d(TAG, this.toString()+ "  onStop()");//Arti
